...
subscribeAndRun=function subscribeAndRun(listener,value){
...
subscriptions=[];this.
backlog=[];}var _proto3=PSStreamModel.prototype;_proto3.
subscribe=function subscribe(listener){
var subscription=new PSSubscription(this,listener);
this.subscriptions.push(subscription);
...
subscribeAndRun=function subscribeAndRun(listener){var value=arguments.length>1&&arguments[1]!==undefined?arguments[1]:null;
var subscription=this.subscribe(listener);
subscription.listener(value);
return subscription;
};_proto3.
