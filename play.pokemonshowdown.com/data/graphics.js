...
quiverdance:{
anim:function(scene,_ref5){var attacker=_ref5[0];
...
lifedew:{
anim:function(scene,_ref22){var attacker=_ref22[0],defenders=_ref22.slice(1);for(var _i2=0;_i2<
...
lunarblessing:{
anim:function(scene,_ref69){var attacker=_ref69[0],defenders=_ref69.slice(1);for(var _i6=0;_i6<
...
shelltrap:{
anim:function(scene,_ref180){var attacker=_ref180[0],defenders=_ref180.slice(1);for(var _i8=0;_i8<
...
defenders.length;_i16++){var defender=defenders[_i16];for(var _i18=0,_ref212=
['mistball','heart'];_i18<_ref212.length;_i18++){var effect=_ref212[_i18];
for(var i=0;i<4;i++){
...
defenders.length;_i20++){var defender=defenders[_i20];for(var _i22=0,_ref215=
['blackwisp','lightning'];_i22<_ref215.length;_i22++){var effect=_ref215[_i22];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
boomburst:{
anim:function(scene,_ref225){var attacker=_ref225[0],defenders=_ref225.slice(1);for(var _i26=0;_i26<
...
heatwave:{
anim:function(scene,_ref226){var attacker=_ref226[0],defenders=_ref226.slice(1);for(var _i28=0;_i28<
...
icywind:{
anim:function(scene,_ref253){var attacker=_ref253[0],defenders=_ref253.slice(1);for(var _i30=0;_i30<
...
sludgewave:{
anim:function(scene,_ref263){var attacker=_ref263[0],defenders=_ref263.slice(1);for(var _i32=0;_i32<
...
rockslide:{
anim:function(scene,_ref275){var attacker=_ref275[0],defenders=_ref275.slice(1);for(var _i34=0;_i34<
...
thousandarrows:{
anim:function(scene,_ref278){var attacker=_ref278[0],defenders=_ref278.slice(1);for(var _i36=0;_i36<
...
thousandwaves:{
anim:function(scene,_ref279){var attacker=_ref279[0],defenders=_ref279.slice(1);for(var _i38=0;_i38<
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i40=0,_ref289=

['x','y',''];_i40<_ref289.length;_i40++){var axis=_ref289[_i40];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref291){var attacker=_ref291[0],defenders=_ref291.slice(1);for(var _i42=0;_i42<
...
mysticalpower:{
anim:function(scene,_ref312){var attacker=_ref312[0];
scene.showEffect('mistball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
surf:{
anim:function(scene,_ref332){var attacker=_ref332[0],defenders=_ref332.slice(1);for(var _i47=0;_i47<
...
muddywater:{
anim:function(scene,_ref334){var attacker=_ref334[0],defenders=_ref334.slice(1);for(var _i49=0;_i49<
...
lavaplume:{
anim:function(scene,_ref336){var attacker=_ref336[0],defenders=_ref336.slice(1);for(var _i51=0;_i51<
...
dragonenergy:{
anim:function(scene,_ref337){var attacker=_ref337[0],defenders=_ref337.slice(1);for(var _i53=0;_i53<
...
eruption:{
anim:function(scene,_ref338){var attacker=_ref338[0],defenders=_ref338.slice(1);for(var _i55=0;_i55<
...
waterspout:{
anim:function(scene,_ref339){var attacker=_ref339[0],defenders=_ref339.slice(1);for(var _i57=0;_i57<
...
prepareAnim:function(scene,_ref342){var attacker=_ref342[0];
scene.showEffect('electroball',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
darkvoid:{
anim:function(scene,_ref367){var attacker=_ref367[0],defenders=_ref367.slice(1);for(var _i61=0;_i61<
...
BattleMoveAnims['shellsidearmtop']={anim:BattleMoveAnims['poisonjab'].anim};
BattleMoveAnims['shellsidearmbottom']={anim:BattleMoveAnims['sludgebomb'].anim};
