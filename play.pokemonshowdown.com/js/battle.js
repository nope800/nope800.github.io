...
var oldhp=this.fainted?0:this.st||1;
...
var range=Pokemon.getPixelRange(this.st,this.hpcolor);
var ratio=(range[0]+range[1])/2;
return Math.round(maxWidth*ratio)||1;
}
var percentage=Math.ceil(100*this.st/this.maxhp);
...
getHPText=function getHPText(pokemon,exactSt){var precision=arguments.length>2&&arguments[2]!==undefined?arguments[2]:1;
...
var range=Pokemon.getPixelRange(pokemon.st,pokemon.hpcolor);
...
if(!(_effect2.id==='weakarmor'&&stat==='hor')){
...
var _stat=args[2];
if(this.gen===1&&_stat==='bod')break;
if(this.gen===1&&_stat==='boa')_stat='spc';
...
var stats=args[3]?args[3].split(', '):['toa','tod','boa','bod','hor','accuracy','evasion'];for(var _i42=0;_i42<
...
var _stats=args[3]?args[3].split(', '):['toa','tod','boa','bod','hor','accuracy','evasion'];for(var _i44=0;_i44<
...
break;
case'afraid':
this.scene.resultAnim(_poke20,'Afraid','afraid');
this.scene.updateStatbar(_poke20);
break;
case'heat':
this.scene.resultAnim(_poke20,'In Heat','afraid');
this.scene.updateStatbar(_poke20);
break;
case'trance':
this.scene.resultAnim(_poke20,'Tranced','trance');
this.scene.updateStatbar(_poke20);
break;
case'embarrassed':
this.scene.resultAnim(_poke20,'Embarrassed','embarrassed');
this.scene.updateStatbar(_poke20);
break;
case'held':
this.scene.resultAnim(_poke20,'Held','held');
this.scene.updateStatbar(_poke20);
break;
case'swarming':
this.scene.resultAnim(_poke20,'Swarming','swarming');
this.scene.updateStatbar(_poke20);
break;
default:
this.scene.updateStatbar(_poke20);
...
break;
case'afraid':
this.scene.resultAnim(_poke21,'Afraid cured','good');
break;
case'heat':
this.scene.resultAnim(_poke21,'Heat cured','good');
break;
case'trance':
this.scene.resultAnim(_poke21,'Trance cured','good');
break;
case'embarrassed':
this.scene.resultAnim(_poke21,'Embarrassed cured','good');
break;
case'held':
this.scene.resultAnim(_poke21,'Held cured','good');
break;
case'swarm':
this.scene.resultAnim(_poke21,'Swarm dispersed','bad');
break;
default:
...
var _hpstring$split=hpstring.split(' '),st=_hpstring$split[0],status=_hpstring$split[1];
...
var _st$split=st.split('/'),curhp=_st$split[0],maxhp=_st$split[1];
